...
$reportData | Export-Csv -Path "$Name UniquePermissions_Report_$timestamp.csv" -NoTypeInformation -Encoding UTF8

Write-Host "Report has been generated and saved to '$Name UniquePermissions_Report_$timestamp.csv'." -ForegroundColor Green
